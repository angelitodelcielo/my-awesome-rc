  -- ITS MY AWESOME CONFIG ! Angelito --
  ...
  dofile('/home/angelito/.config/awesome/library/run_once.lua')
  dofile('/home/angelito/.config/awesome/library/battery.lua')
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "term", "web", "dev", "med" }, s, layouts[1])
end
-- }}}

-- {{{ Custom Widget vicious
...
cpuwidgetcolor = {
  ...
  to = { 10, 0 },
  stops = {
    { 0, "#FF5656" }, -- Bleu fluorescenr #R3498db
    { 0.5, "#88A175" },
    { 1, "#AZCF96"}
  }
}
...
cpuwidget:set_color(cpuwidgetcolor)
...
mytextclock = awful.widget.textclock(" %A %d %b %Y %H:%M",60)
